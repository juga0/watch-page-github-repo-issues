"""Configuration for watch-github-repo-issues agent."""
...
# NOTE: different from watch-url
WATCH_PAGE_MODULE_DIR = 'watch-url'
WATCH_PAGE_MODULE_PATH = join(ROOT_PROJECT_PATH, WATCH_PAGE_MODULE_DIR)

# FIXME: get this name as the name of the module
AGENT_TYPE = 'watch'
AGENT_NAME = 'page-github-repo-issues'
AGENT_SUFFIX = 'juga'
NAME_SEPARATOR = '-'
